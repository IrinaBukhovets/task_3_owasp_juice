...
class BaseElements(BasePage):
    ...
    locator_search_query = (By.XPATH, "//mat-form-field[@class='mat-form-field mat-search_field ng-tns-c21-6 mat-primary ng-tns-c113-1 ng-trigger ng-trigger-slideInOut mat-form-field-type-mat-input mat-form-field-appearance-standard mat-form-field-can-float ng-valid ng-star-inserted ng-dirty ng-touched']")
